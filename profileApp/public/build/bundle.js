...
var _mainLayout = __webpack_require__(66);
...
var enhancers = (0, _redux.compose)(window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());

var reducers = (0, _redux.combineReducers)({
     testReducer: _reducers.testReducer
});
...
exports.default = {
     ...
     createStore: function createStore() {
          store = (0, _redux.createStore)(reducers, (0, _redux.applyMiddleware)(_reduxThunk2.default, _reduxLogger2.default), enhancers);
          return store;
     },
...
exports.testReducer = undefined;

var _testReducer = __webpack_require__(63);

var _testReducer2 = _interopRequireDefault(_testReducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.testReducer = _testReducer2.default;
...
var Home = function (_Component) {
     ...
     _createClass(Home, [{
          ...
          value: function render() {
               var list = this.props.mainLayoutProps.tests;
...
var dispatchToProps = function dispatchToProps(dispatch) {
     return {
          createTest: function createTest() {
               return dispatch(_actions2.default.createTest());
          }
     };
};
...
exports.default = {
     createTest: function createTest(test) {
          console.log('action called');
          return {
               type: _constants2.default.TEST_ACTION,
               data: newtest
          };
     }
